...
<nav class="navbar navbar-inverse" id="navigation">
            ...
            <div class="collapse navbar-collapse" id="navItems">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${addDoc_url}" data-toggle="tooltip" data-placement="bottom" title="Add Document"><img src="${addDoc}" alt="add documents"></a></li>
                    <li><a href="${editDoc_url}" data-toggle="tooltip" data-placement="bottom" title="Edit Document"><img src="${editDoc}" alt="edit documents"></a></li>
                </ul>
...
<nav class="navbar navbar-inverse" id="navigation">
            ...
            <s:url var="editDoc_url" value="/depAdmin/documents" />
