...
<html>
    ...
    <body>
        ...
        <s:url var="addStaff_url" value="/admin/saveStaff"/>
        <div class="container-fluid">
            <div class="col-md-8 col-md-offset-2 ">
                <h3 class="text-center well">Add Staff</h3>
                <f:form class="col-md-8 col-md-offset-2" action="${addStaff_url}" modelAttribute="staff" method="POST">
                <div class="form-group">
                    <label for="firstName">Firstname</label>
                    <f:input path="first_name" class="form-control" id="firstName" required="required"/>
                </div>
                <div class="form-group">
                    <label for="lastName">Lastname</label>
                    <f:input path="last_name" class="form-control" id="lastName" required="required"/>
                </div>
                <div class="form-group">
                    <label for="department">Department</label>
                    <f:select path="department" class="form-control" required="required">
                ...
                <div class="form-group">
                    ...
                    <f:input path="designation" class="form-control" id="designation" required="required"/>
                </div>
                <div class="form-group">
                    <label for="profile">Staff Profile Url</label>
                    <f:input path="profile_url" class="form-control" id="profile" required="required"/>
                </div>
                <div class="form-group">
