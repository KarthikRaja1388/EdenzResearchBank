...
<html>
    <head>
        ...
        <title>Past Projects - Edenz Research Bank</title>
    ...
    <body>
        ...
        <main style="height: 100vh;" class="container-fluid">
            <div class="container">
                <h3 class="text-center well">Past Projects</h3>
                <div class="col-md-8" id="colLeft">
                <c:forEach var="pastProjects" items="${projects}">
                    <s:url var="docDetails_url" value="/docHandle">
                        <s:param name="documentId" value="${pastProjects.project_id}" />
                    </s:url>
                        <div class="well">
                            <a href="${docDetails_url}"><h4>${pastProjects.title}</h4></a>
                            <h6>
                            ...
                            <div style="overflow: hidden;height:60px;">
                                <p class="textLimit">${pastProjects.description}</p>
                            </div>
                        </div>
                </c:forEach>
                </div>
