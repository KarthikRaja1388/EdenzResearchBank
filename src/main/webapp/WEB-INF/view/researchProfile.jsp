...
<html>
    ...
    <body>
        ...
        <s:url var="jquery_url" value="/Resources/js/jquery-1.9.1.min.js" />
        <s:url var="bootstarpJs_url" value="/Resources/js/bootstrap.min.js"/>
        <script src="${jquery_url}" ></script>
        <script src="${bootstarpJs_url}"></script>
    </body>
</html>
