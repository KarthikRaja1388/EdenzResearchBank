    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="col-md-8 col-md-offset-2 ">
                <h3 class="text-center well">Add New User</h3>
                <f:form class="col-md-8 col-md-offset-2" action="${addUser_action}"  modelAttribute="command" method="GET">
                    <div class="form-group">
                        <label>First Name :</label>
                        <f:input path="first_name" placeholder="FirstName" class="form-control"/>
                    </div>
                    <div class="form-group">
                        <label>Last Name :</label>
                        <f:input path="last_name" placeholder="LastName" class="form-control"/>
                    </div>
                    <div class="form-group">
